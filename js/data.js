...
const PEOPLE = [
  ...
  { id: 'p11', name: 'Maître Fidy',       role: 'Grand Maître', level: 'Enseignant',    belt: 'noir', progress: 100, attendance: 100, sessions: 0, techniques: 48, resident: true, since: '2011-04-30', room: 'B101', phone: '034 00 001 01', dues: '—' },
...
const SESSIONS = [
  ...
  { id: 's2', title: 'Kung-Fu avancé',        time: '18:00', dur: '90 min', group: 'Groupe avancé',        master: 'Maître Fidy', count: 12, place: 'Grande salle', state: 'next' },
  ...
  { id: 's4', title: 'Formes traditionnelles', time: '07:00', dur: '60 min', group: 'Tous niveaux',        master: 'Maître Fidy', count: 31, place: 'Terrasse nord', state: 'next', day: 'Demain' }
];
...
const GROUPS = [
  ...
  { id: 'g3', name: 'Groupe avancé',        members: 12, master: 'Maître Fidy', slots: 'Mar · Jeu · Sam — 18:00' },
  { id: 'g4', name: 'Résidents',            members: 18, master: 'Maître Fidy', slots: 'Quotidien — 05:30' }
];

/* ---------------------------------------------- Technique & formes */
const TECHNIQUES = [
  { id: 't1', name: 'Fijoroana soavaly',  fr: 'Position du cavalier', belt: 'blanc',  cat: 'Position', mastered: true },
  { id: 't2', name: 'Fijoroana mandroso', fr: 'Position avancée',     belt: 'blanc',  cat: 'Position', mastered: true },
  { id: 't3', name: 'Totohondry mahitsy', fr: 'Poing direct',         belt: 'jaune',  cat: 'Frappe',   mastered: true },
  { id: 't4', name: 'Felatanana mandidy', fr: 'Paume tranchante',     belt: 'jaune',  cat: 'Frappe',   mastered: true },
  { id: 't5', name: 'Daka mahitsy',       fr: 'Coup de pied direct',  belt: 'jaune',  cat: 'Jambe',    mastered: true },
  { id: 't6', name: 'Fijoroana ambany',   fr: 'Position basse',       belt: 'orange', cat: 'Position', mastered: true },
  { id: 't7', name: 'Daka mipoaka',       fr: 'Jambe jaillissante',   belt: 'orange', cat: 'Jambe',    mastered: true },
  { id: 't8', name: 'Fafan-tongotra',     fr: 'Balayage bas',         belt: 'orange', cat: 'Jambe',    mastered: false },
  { id: 't9', name: 'Dona kiho',          fr: 'Frappe du coude',      belt: 'orange', cat: 'Frappe',   mastered: false },
  { id: 't10',name: 'Fijoroana miandry',  fr: 'Position d’attente',   belt: 'vert',   cat: 'Position', mastered: false },
  { id: 't11',name: 'Daka mitsambikina',  fr: 'Coup de pied sauté',   belt: 'vert',   cat: 'Jambe',    mastered: false },
  { id: 't12',name: 'Fisamborana',        fr: 'Saisie et contrôle',   belt: 'bleu',   cat: 'Contrôle', mastered: false }
];

const FORMS = [
  { id: 'f1', name: 'Dian’ny voromahery', fr: 'La marche de l’aigle',    belt: 'jaune',  moves: 18, dur: '1 min 10' },
  { id: 'f2', name: 'Rivotra mandalo',    fr: 'Le vent qui passe',       belt: 'orange', moves: 32, dur: '1 min 45' },
  { id: 'f3', name: 'Vato miorina',       fr: 'La pierre dressée',       belt: 'vert',   moves: 46, dur: '2 min 20' },
  { id: 'f4', name: 'Mamba matory',       fr: 'Le crocodile endormi',    belt: 'bleu',   moves: 62, dur: '3 min' }
];

/* ---------------------------------------------- Examens */
const EXAM = {
  id: 'e1', from: 'jaune', to: 'orange', date: '15 août 2026', time: '09:00',
  place: 'Grande salle', jury: ['Maître Fidy', 'Maître Ravaka'], candidates: 14,
  trials: [
...
const JOURNEY = [
  ...
  { time: 'Juin 2024',  title: 'Première forme apprise',     meta: 'Dian’ny voromahery — 18 mouvements',    state: 'done' },
...
const ME = 'p11';                       /* Maître Fidy, grand maître */
...
const MESSAGES = {
  c4: [
    ...
    { from: 'p1', text: 'La forme Dian’ny voromahery. Je perds l’équilibre au troisième enchaînement.', time: '20:05' },
    { day: 'Aujourd’hui' },
